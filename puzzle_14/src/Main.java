...
public class Main {
    ...
    static int getOreRequired(Map<List<String>, String> recipes, List<String> key, Map<String, Integer> manufactoredFromOre) {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Integer> manufactoredFromOre = new HashMap<>();
        recipes.forEach(recipe -> {
            ...
            if(key.get(0).contains("ORE")) manufactoredFromOre.put(value.substring(value.indexOf(" ") + 1), 0);
        });
        List<String> firstKey = new ArrayList<>(getKeyByValue(recipeMap, "1 FUEL")).get(0);
        System.out.println(firstKey);
        System.out.println(getOreRequired(recipeMap, firstKey, manufactoredFromOre));
